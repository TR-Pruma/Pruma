CREATE TABLE pedido_marketplace (
                                    pedido_marketplace_id BIGINT        AUTO_INCREMENT PRIMARY KEY,
...
CREATE INDEX idx_pedido_mkt_profissional ON pedido_marketplace(profissional_id);
CREATE INDEX idx_pedido_mkt_obra         ON pedido_marketplace(obra_id);
CREATE INDEX idx_pedido_mkt_fornecedor   ON pedido_marketplace(fornecedor_id);
CREATE INDEX idx_pedido_mkt_status       ON pedido_marketplace(status);

CREATE TABLE item_pedido_marketplace (
                                         item_pedido_marketplace_id BIGINT        AUTO_INCREMENT PRIMARY KEY,
...
CREATE INDEX idx_item_pedido_mkt_pedido ON item_pedido_marketplace(pedido_marketplace_id);
CREATE INDEX idx_item_pedido_mkt_insumo ON item_pedido_marketplace(insumo_id);

CREATE TABLE proposta_credito (
                                  proposta_credito_id  BIGINT        AUTO_INCREMENT PRIMARY KEY,
                                  profissional_id      INT           NOT NULL,
