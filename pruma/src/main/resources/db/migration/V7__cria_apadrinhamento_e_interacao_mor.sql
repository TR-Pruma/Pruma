-- V7: Cria tabelas apadrinhamento_rede e interacao_campo_mor

CREATE TABLE IF NOT EXISTS apadrinhamento_rede (
    apadrinhamento_id BIGSERIAL   PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_apadrinhamento_padrinho ON apadrinhamento_rede(padrinho_id);
CREATE INDEX IF NOT EXISTS idx_apadrinhamento_afilhado ON apadrinhamento_rede(afilhado_id);
CREATE INDEX IF NOT EXISTS idx_apadrinhamento_status   ON apadrinhamento_rede(status);

-- -------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS interacao_campo_mor (
...
CREATE INDEX IF NOT EXISTS idx_mor_profissional ON interacao_campo_mor(profissional_id);
CREATE INDEX IF NOT EXISTS idx_mor_obra         ON interacao_campo_mor(obra_id);
CREATE INDEX IF NOT EXISTS idx_mor_status       ON interacao_campo_mor(status_processamento);
CREATE INDEX IF NOT EXISTS idx_mor_timestamp    ON interacao_campo_mor(timestamp_campo);
