...
public interface LogAlteracaoAuxRepositoryPort {
    ...
    /** Retorna página de registros de LogAlteracaoAux. */
    Page<LogAlteracaoAux> findAll(Pageable pageable);
    ...
    /** Remove um LogAlteracaoAux pelo ID. */
    void deleteById(Integer id);

    /** Remove um LogAlteracaoAux pela entidade. */
